...
def initialize_ide_rules(ide: str = "cursor", project_path: Optional[str] = None) -> Dict[str, Any]:
    ...
    if ide == "cursor":
        ...
        rules = [
            ("001-project-basics.md", """# Project Basics
- Follow standard project structure
- Use consistent coding style
- Document key decisions"""),
            
            ("002-code-guidelines.md", """# Code Guidelines
...
- Optimize performance when needed""")
    ...
    rules_file = project_path / (
        ".windsurfrules" if ide == "windsurf"
        else ".clinerules" if ide == "cline"
        else ".github/copilot-instructions.md" if ide == "copilot"
        else None
    )
    ...
    rules_file.write_text(f"""# {ide.title()} Rules
